...
def test_build_features_handles_mixed_exam_time_types() -> None:
    first = pd.DataFrame(
        [{"study_id": "s1", "exam_time": pd.Timestamp("2024-06-01"), "standard_code": "HY-BZ-001", "numeric_value": 4.8, "is_abnormal": False, "category": "血脂"}]
    )
    second = pd.DataFrame(
        [{"study_id": "s2", "exam_time": "2024-12-12", "standard_code": "HY-BZ-001", "numeric_value": 5.65, "is_abnormal": True, "category": "血脂"}]
    )
